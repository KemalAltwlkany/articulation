...
def precompute_FON_objective_space(n_samples=100, n_samples_Pareto=100, save=True, save_folder=None, save_name=None, show=False):
    if save_folder is None:
        save_folder = '/home/kemal/Programming/Python/Articulation/data/precomputed_data/'
    if save_name is None:
...
if __name__ == '__main__':
    #precompute_IM1_objective_space()
    #precompute_BK1_objective_space()
    #precompute_SCH1_objective_space()
    #precompute_FON_objective_space()
